...
class AESFieldsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $fields = [
            ...
            [
                ...
                "answer" => null,
                "choices" => [
                    "(+) by immunochemistry, immunofluorescence PCR",
                    "Epidemiological link to confirmed case",
                    "Elevated/stable antibody titres to JE virus",
                    "Negative",
                    "Not Done"
                ],
                "display" => true,
